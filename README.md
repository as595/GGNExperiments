...
The central term in this expression is $\nabla_f^2 a_n(f_n(\theta))$, which is the Hessian of the log-likelihood. In the case of a Gaussian likelihood this is equal to unity.
